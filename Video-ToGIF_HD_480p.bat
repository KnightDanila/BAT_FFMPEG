...
REM //////////////////// MAIN \\\\\\\\\\\\\\\\\\\\\\\\\
		...
		ffmpeg.exe -i %%x -i Video-ToGIF_palette.png -filter_complex "fps=24,scale=-1:480:flags=lanczos[x];[x][1:v]paletteuse=dither=bayer:bayer_scale=5" "%%~nx_output_HD_480p.gif"
